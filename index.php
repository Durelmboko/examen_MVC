...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
  <div class="container">
    <a class="navbar-brand" href="#">DUREL_SERVICE</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="view/agent/add.php">ajouter</a></li>
            <li><a class="dropdown-item" href="view/agent/liste.php">lister</a></li>
